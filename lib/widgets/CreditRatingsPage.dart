...
class CreditRatingsPage extends StatelessWidget {
  const CreditRatingsPage({super.key});
          ...
          Expanded(
            child: Center(
              child: Padding(
                ...
                child: SvgPicture.asset('assets/images/Illustration3.svg'),
              ),
            ),
          ),
          const Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                      "Track your credit ratings and qualify for better loans.",
